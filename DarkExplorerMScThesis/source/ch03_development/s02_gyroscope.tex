...
Jeżeli urządzenie do którego przymocowany jest żyroskop zacznie się obracać,
...
mierzonych przez żyroskop dla długich okresów pomiarowych.
 ...
 \begin{figure}[h!]
 \centering
 \subfloat[Zmiany wartości rejestrów podczas obrotu]{\label{fig:gyro-angle-vel}
 	\includegraphics[width=0.49\textwidth]{../images/ch04/gyro-angle-velocity.png}}
 %\hfill \\
 \subfloat[Zmiany kąta wychylenia z pozycji startowej]{\label{fig:gyro-angle}
 	\includegraphics[width=0.49\textwidth]{../images/ch04/gyro-angle.png}}
...
Zgodnie z notą katalogową\cite{L3G4200DDataSheet} dostępną na stronie
...
Płytka modułu została zaprojektowana z wykorzystaniem elementów
