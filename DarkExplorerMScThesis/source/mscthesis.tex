...
% Ustawienia parametrów listingu
\definecolor{StringColor}{rgb}{0.86,0,0}
\definecolor{CommentColor}{rgb}{0,0,0.73}
\definecolor{KeywordColor}{rgb}{0,0.46,0}

\lstset{%
basicstyle=\ttfamily\footnotesize, %\ttfamily,		% the size of the fonts that are used for the code
extendedchars=\true,				% allows national characters in code
...
breaklines=\true,                % sets automatic line breaking
}
...
\vspace{22ex}
{\large \bf \textsf{Kraków, maj 2011}}
\end{center}
...
{\sf Oświadczam, świadomy(-a) odpowiedzialności karnej za poświadczenie
nieprawdy, że niniejszą pracę dyplomową wykonałem(-am) osobiście i samodzielnie
i~nie~korzystałem(-am) ze źródeł innych niż wymienione w pracy.}
...
\begin{itemize}
\item zapoznanie się z zasadą działania i budową robota Dark Explorer,
\item zapoznanie się z narzędziami i zasadami tworzenia oprogramowania
sterującego pracą mikrokontrolera wbudowanego w robota,
\item dyskusja i analiza możliwych ścieżek rozwojowych zarówno warstwy
sprzętowej jaki i programowej robota,
\item sporządzenie sprawozdania z praktyki.
\end{itemize}
\item Kontynuacja prac związanych z tematem pracy magisterskiej.
\item Zbieranie wyników z fazy testowania oprogramowania i sprzętu.
\item Analiza wyników testów, ich omówienie i zatwierdzenie przez opiekuna.
\item Opracowanie redakcyjne pracy.
\end{enumerate}

\noindent
Termin oddania w dziekanacie: maj 2011\\[1cm]
...
\noindent
{\bf{Merytoryczna ocena pracy przez opiekuna:}}
\vfill
...
{\bf{Merytoryczna ocena pracy przez recenzenta:}}
\vfill
