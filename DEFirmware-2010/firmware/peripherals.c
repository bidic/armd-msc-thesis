...
//	PMC_EnablePeripheral(AT91C_ID_ADC);
...
//	switch (channel_mask) {
//	case AT91C_ADC_CH4:
//		return (AT91C_BASE_ADC->ADC_CDR4 & 0xFF);
//		break;
//	case AT91C_ADC_CH5:
//		return (AT91C_BASE_ADC->ADC_CDR5 & 0xFF);
//		break;
//	case AT91C_ADC_CH6:
//		return (AT91C_BASE_ADC->ADC_CDR6 & 0xFF);
//		break;
//	case AT91C_ADC_CH7:
//		return (AT91C_BASE_ADC->ADC_CDR7 & 0xFF);
//		break;
//	default:
//		return 0;
//	}
...
//	switch (channel_mask) {
//	case AT91C_ADC_CH4:
//		return (AT91C_BASE_ADC->ADC_CDR4 & 0x300) >> 8;
//		break;
//	case AT91C_ADC_CH5:
//		return (AT91C_BASE_ADC->ADC_CDR5 & 0x300) >> 8;
//		break;
//	case AT91C_ADC_CH6:
//		return (AT91C_BASE_ADC->ADC_CDR6 & 0x300) >> 8;
//		break;
//	case AT91C_ADC_CH7:
//		return (AT91C_BASE_ADC->ADC_CDR7 & 0x300) >> 8;
//		break;
//	default:
//		return 0;
//	}
