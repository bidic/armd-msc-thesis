...
void PIT_Configure(int czas_us)
{
  ...
  AIC_ConfigureIT(AT91C_ID_SYS, AT91C_AIC_PRIOR_LOWEST | AT91C_AIC_SRCTYPE_HIGH_LEVEL, SYSTEM_INTERRUPT_irq_handler);
...
//                          AT91C_US_NBSTOP_1_BIT;      /* 1 Stop Bit  */
  ...
  //konfiguracja przerwania
  AIC_ConfigureIT(AT91C_ID_US0,  0x3 | AT91C_AIC_SRCTYPE_HIGH_LEVEL, UART0_DMA_irq_handler);
