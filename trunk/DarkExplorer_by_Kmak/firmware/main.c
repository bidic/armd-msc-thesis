...
* Plik       : main.c
* Zawartosc  : Inicjalizacje pocz¹tkowe, obs³uga przerwañ systemowych,
             : interpretacja komend, pêtla g³ówna
* Autor      : Pawe³ Kmak
* Data       : 1.11.2009
**/
...
{
  //impuls od timera PIT pojawia siê co 18-20ms
  ...
  if(PitState==0)
  {
    ...
    AT91F_PIO_SetOutput( AT91C_BASE_PIOA, PIO_PA0 );
          ...
          //do wygenerowania odstêpu miêdzy impulsami
...
{
RX_Buffer[RX_Counter] = UART0_Read();
...
int main(void)
{
  ...
  //wlaczenie UART0
  //UART0_DMA_Configure(115200); //115.2kbit/s
  ...
  //konfiguracja wyjœcia diody led mocy
