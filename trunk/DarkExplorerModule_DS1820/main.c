...
//{
//    if(state)
//        AT91F_PIO_SetOutput( AT91C_BASE_PIOA, PIO_PA14 ); //ustawienie stanu wysokiego
//    else
//        AT91F_PIO_ClearOutput( AT91C_BASE_PIOA, PIO_PA14 ); //ustawienie stanu niskiego
//
//    return state;
//}
