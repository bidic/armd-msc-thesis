...
\newpage
\section{Środowisko rozwojowe systemu wbudowanego}
\include{ch03_software/s01_windows}
\include{ch03_software/s02_linux}

\newpage
\section{Środowisko rozwojowe dla komputerów stacjonarnych}
\include{ch03_software/s03_java}
\include{ch03_software/s04_c_sharp}

\newpage
\section{Środowisko rozwojowe dla urządzeń mobilnych}
\include{ch03_software/s05_windows_mobile}
\include{ch03_software/s06_java_mobile}

\newpage
\section{Rozwój warstwy sprzętowej}
\include{ch04_development/s01_accelerometer}
\include{ch04_development/s02_gyroscope}
\include{ch04_development/s03_ir_sensors}
\include{ch04_development/s04_magnetometer}
\include{ch04_development/s05_lcd_display}
\include{ch04_development/s06_face_detection}

\newpage
\part{Podsumowanie}
\include{ch05_summary/s01_summary}
