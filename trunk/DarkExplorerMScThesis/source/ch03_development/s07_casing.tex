...
\begin{figure}[h!]
 ...
 obudowy]{\label{fig:SesnsorBoardA}\includegraphics[width=0.535\textwidth]{../images/ch04/sensor_board.png}}
 \subfloat[Rozmieszczenie poszczególnych elementów wewnątrz
 obudowy]{\label{fig:SesnsorBoardB}\includegraphics[width=0.465\textwidth]{../images/ch04/sensor_board_simple.png}}
